...
public static class LuaBinding
{
    ...
    static BindType[] binds = new BindType[]
    {
        ...
        _GT(typeof(GTLib)),
        _GT(typeof(MPObject)),
        _GT(typeof(MessageTransmitter)),
        //_GT(typeof(MessageHandler)),
        _GT(typeof(INetManager)),
        _GT(typeof(IAssetManager)),
        _GT(typeof(IGameManager)),
        _GT(typeof(Logger)),
        _GT(typeof(LuaMessageTransmitter)),
