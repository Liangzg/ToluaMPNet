...
namespace com.gt.mpnet
{
    ...
    public class MessageTransmitter 
    {
        ...
        public void SendExtensionRequest(string extCmd)
        {
        ...
        public void SendExtensionRequest(string extCmd, IMPObject parameters)
        {
        ...
        public void SendExtensionRequest(string extCmd, IMPObject parameters, bool useUDP)
        {
